        ...
        <div class="app-main">
            <nav class="sidebar bg-primary">
                <ul>
                    ...
                    <li>
                        <a href="index.php?pg=order"><i class="fa-solid fa-cart-shopping ico-side"></i>Quản lí đơn hàng</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="index.php?pg=banner"><i class="fa-solid fa-user ico-side"></i>Quản lí banner</a>
                    </li>
                    <li>
                        <a href="index.php?pg=comment"><i class="fa-solid fa-user ico-side"></i>Quản lí bình luận</a>
                    </li>
                </ul>
            </nav>
